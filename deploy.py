...
place=st.sidebar.text_input("NAME OF THE CITY :", "")
unit=st.sidebar.selectbox("Select Temperature Unit",("Celsius","Fahrenheit"))
g_type=st.sidebar.selectbox("Select Graph Type",("Line Graph","Bar Graph"))
b=st.sidebar.button("SUBMIT")
